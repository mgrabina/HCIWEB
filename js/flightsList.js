      ...
      var ticket = "<div id=\"ticket"+ i +"\">" +
                ...
                "<div class=\"row row-ticket\" id=\"rowTicketBottom\">" +
                  ...
                  "<div class=\"col-md-2 dark\" id=\"rightBorderBottom\">" +
                    "<button type=\"button\" class=\"btn btn-grey btnContinue\"  flightN=\""+ flightNumber +"\" airline=\""+ airline +"\" arrTime=\""+ arrTime +"\" depTime=\""+ depTime +"\" depDate=\""+ depDate +"\"  arrDate=\""+ arrDate +"\" totalPrice=\""+ totalPrice +"\" depAirportInfo=\""+ depAirportInfo +"\" arrAirportInfo=\""+ arrAirportInfo +"\">continue</button>" +
                  "</div>" +
                "</div>" +
              "</div>"
