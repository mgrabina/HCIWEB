...
$.getJSON(url,function(data){
   ...
   for( i = 0; i<size; i++){
      ...
      var arrTime = data.flights[i].outbound_routes[0].segments[0].arrival.date.substring(12, 16);
        ...
        var depOrArr = (getQueryV("departure")==false)?"departure":"arrival";
      ...
      var ticket = "<div id=\"ticket"+ i +"\">" +
                ...
                "<div class=\"row row-ticket\" id=\"rowTicketBottom\">" +
                  ...
                  "<div class=\"col-md-2 dark\" id=\"rightBorderBottom\">" +
                    "<button type=\"button\" class=\"btn btn-grey btnContinue\" prices=\""+ prices +"\"  flightN=\""+ flightNumber +"\" airline=\""+ airline +"\" arrTime=\""+ arrTime +"\" depTime=\""+ depTime +"\" depDate=\""+ depDate +"\"  arrDate=\""+ arrDate +"\" totalPrice=\""+ totalPrice +"\" depAirportInfo=\""+ depAirportInfo +"\" arrAirportInfo=\""+ arrAirportInfo +"\">continue</button>" +
                  "</div>" +
                "</div>" +
              "</div>"
